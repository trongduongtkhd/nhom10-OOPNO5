...
public class GymMemberView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel20.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/search.png"));
        ...
        jLabel22.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/viewSearchView.png"));
        jLabel22.setText("=");
        ...
        btnCancelSearch.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/cancel.png"));
        ...
        ImageIcon imageIcon2 = new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/sorting.png");
        ...
        btnResidentUndo.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/LogOut.png"));
        ...
        btnSearch.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/search.png"));
        ...
        ComboBoxRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<none>", "MMA", "Boxing","Gym","Yoga" }));
        jPanel1.add(ComboBoxRole);
        ComboBoxRole.setBounds(970, 100, 260, 40);
        ComboBoxRole.setOpaque(false);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setText("Loại thành viên:");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(800, 100, 150, 40);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(590, 310, 100, 40);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(260, 310, 120, 40);
       ...
       ComboBoxGoiTap = new javax.swing.JComboBox<>();
ComboBoxGoiTap.setFont(new java.awt.Font("Times New Roman", 0, 20));
ComboBoxGoiTap.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<none>", "1 tháng", "3 tháng", "6 tháng", "12 tháng" }));
jPanel1.add(ComboBoxGoiTap);
ComboBoxGoiTap.setBounds(390, 100, 250, 40); // Điều chỉnh vị trí cho phù hợp
ComboBoxGoiTap.setOpaque(false);
        ...
        btnAdd.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/add.png"));
        btnAdd.setText("Thêm");
        ...
        btnEdit.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/Edit.png"));
        ...
        btnDelete.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/delete.png"));
        ...
        btnClear.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlyphonggym/view/trash.png"));
...
private void FieldIDFamilyActionPerformed(java.awt.event.ActionEvent evt) {
    // TODO: Xử lý khi người dùng nhập hoặc thay đổi số hộ khẩu
}
    ...
    public GymMember getResidentInfo() {
        ...
        try {
            ...
            if (ComboBoxGoiTap.getSelectedItem().toString().trim() != null && !"".equals(ComboBoxGoiTap.getSelectedItem().toString().trim())) {
                residents.setIDFamily(ComboBoxGoiTap.getSelectedItem().toString().trim());
            }
            if (CheckBoxMale.isSelected()) residents.setSex("Nam"); else residents.setSex("Nữ");
             // Lấy ID từ dòng đang chọn trong bảng nếu có
        int row = tableResident.getSelectedRow();
        if (row >= 0) {
            int selectedId = Integer.parseInt(tableResident.getModel().getValueAt(row, 0).toString());
            residents.setId(selectedId);
        }
    ...
    public void showListResidents(List<GymMember> list) {
        int size = list.size();
      
        Object [][] residents = new Object[size][10];
    ...
    {
        ComboBoxGoiTap.setSelectedItem(resident.getGoitap()); 
    ...
    public void fillResidentFromSelectedRow(List<GymMember> list) throws ParseException {
        ...
        if (row >= 0) {
            ...
            if (selectedResident != null) {
                ComboBoxGoiTap.setSelectedItem(selectedResident.getGoitap());
    ...
    public void fillResidentFromSelectedRow() throws ParseException {
        ...
        int row = tableResident.getSelectedRow();
        if (row >= 0) {
            ComboBoxGoiTap.setSelectedItem(tableResident.getModel().getValueAt(row, 1).toString()); // Gói tập
    ...
    public void clearResidentInfo() {
        ComboBoxGoiTap.setSelectedItem("<none>");
    ...
    public void showCountListResidents(List<GymMember> list) {
        int size = list.size();
    ...
    public void showStatisticTypeCMT(List<GymMember> list) {
    ...
    public void showStatisticIDFamily(List<GymMember> list) {
    ...
    {
        String id = ComboBoxGoiTap.getSelectedItem().toString().trim();
        btnCancelSearch.setEnabled(false);
        btnSearch.setEnabled(true);
        btnClear.setEnabled(true);
    ...
    private javax.swing.JComboBox<String> ComboBoxGoiTap;
}
